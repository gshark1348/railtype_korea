(() => {
  ...
  const DEMO_RECORDS = [
    ...
    { id: "demo-12", nickname: "서해횡단러너", line: 12, course_name: "청량리 · 인천 전 구간", direction_name: "인천행", route_name: "청량리 → 인천", duration_ms: 426300, accuracy: 99.1, errors: 2, completed_at: minutesAgo(236) }
  ];
