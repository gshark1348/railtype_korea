...
<img src="docs/social-preview-v24.png" alt="RAILTYPE KOREA — 실제 좌표 위에 수도권 도시철도와 KTX 경부고속선을 시각화한 프로젝트 대표 이미지" width="100%">
...
- **호선별 커뮤니티 최고 기록**  
  최근 완주는 전체 노선을 함께 보여주되, 최고 기록은 1–9호선과 KTX 경부고속선을 각각 분리해 같은 노선 안에서만 순위를 비교합니다.
...
- KTX 호남고속선·강릉선과 SRT 등 전국 고속철도 코스 추가
